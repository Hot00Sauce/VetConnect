...
// Fetch the user's profile information including location and role
$sql = "SELECT profile_name, profile_picture, latitude, longitude, role FROM users WHERE id = ?";
...
// Redirect veterinarians to their own dashboard
if (isset($user['role']) && $user['role'] === 'Veterinarian') {
            ...
            <div class="vetList">
                <?php if ($vet_result && $vet_result->num_rows > 0): ?>
                    <?php while($vet = $vet_result->fetch_assoc()): ?>
                        <div class="vetCard">
                            <img src="<?php echo !empty($vet['profile_picture']) ? '../' . htmlspecialchars($vet['profile_picture']) : '../assets/images/default-avatar.png'; ?>" alt="Vet Profile">
                            <div class="vetInfo">
